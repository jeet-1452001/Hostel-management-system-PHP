...
$gpwd=$_POST['gpwd'];
$gconpwd=$_POST['cgpwd'];
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,guardian_email,guardian_password,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) 
values('$roomno','$seater','$feespm','$foodstatus','$stayfrom','$duration','$course','$regno','$fname','$mname','$lname','$gender','$contactno','$emailid','$emcntno','$gurname','$gurrelation','$gurcntno','$guremail','$gpwd','$caddress','$ccity','$cstate','$cpincode','$paddress','$pcity','$pstate','$ppincode')";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssisississsisssi',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$guremail,$gpwd,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$result = $stmt->execute();
if($result)
{
...
{
	echo "<script>alert('Choose another guardian e-mail id!');</script>";
}
}
?>
...
<body>
	...
	<div class="ts-main-content">
		<?php include('includes/slidebar1.php');?>
...
<div class="col-sm-8">
<input type="text" name="fpm" id="fpm"  class="form-control" value="3000" disabled>
</div>
</div>
...
<div class="col-sm-8">
<select name="duration" id="duration" class="form-control" onChange="genbill()">
...
<label class="col-sm-2 control-label" style="color:black">Guardian Email : </label>
<div class="col-sm-8" >
<input type="text" name="gemail" id="gemail"  class="form-control" required="required">
</div>
 Note: You will be using this <span style="color:red">email</span> to login in parent-login.

</div>	

<div class="form-group" style="color:green">
<label class="col-sm-2 control-label" style="color:black">Guardian password : </label>
<div class="col-sm-8">
<input type="password" name="gpwd" id="gpwd"  class="form-control" required="required">
</div>
Note: You will be using this <span style="color:red">password</span>  to login in parent-login.
</div>	

<div class="form-group">
<label class="col-sm-2 control-label"> Confirm password : </label>
<div class="col-sm-8">
<input type="password" name="cgpwd" id="cgpwd"  class="form-control" required="required" onBlur="checksame()">
</div>
</div>	
...
<div class="col-sm-4">
<input type="checkbox" name="adcheck" value="1" style="height:30px;width:30px"/>
</div>
</div>
...
function checksame()
{
	var a= document.getElementById("gpwd").value;
	var b= document.getElementById("cgpwd").value;
	if(a!=b)
	{alert("password and confirm password must be same!!");}
}
function genbill()
{
	var x= document.getElementById("fpm").value;
	var y= document.getElementById("duration").value;
   document.getElementById("ta").value= x*y;
