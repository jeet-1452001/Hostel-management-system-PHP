...
$stmt=$mysqli->prepare("SELECT guardian_email,guardian_password,id FROM registration WHERE guardian_email=? and guardian_password=? ");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Parent Login </h2>
